                    ...
                    <ul class="navbar-nav" id="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="#sidebarApps" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarApps">
                                <i class="ri-apps-2-line"></i> <span data-key="t-apps">Aacdemic</span>
                            </a>
                            <div class="collapse menu-dropdown" id="sidebarApps">
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item">
                                        <a href="#teacherForms" class="nav-link" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="teacherForms" data-key="t-calender">
                                            Forms
                                        </a>
                                        <div class="collapse menu-dropdown" id="teacherForms">
                                            <ul class="nav nav-sm flex-column">
                                                <li class="nav-item">
                                                    <a href="teacher-observation-form.php" class="nav-link" data-key="t-main-calender"> Observation Form  </a>
                                                </li>
                                                <li class="nav-item">
                                                    <a href="apps-calendar-month-grid.html" class="nav-link" data-key="t-month-grid"> Observation Criteria  </a>
                                                </li>
                                            </ul>
                                        </div>
                                        <li class="nav-item">
                                        <a href="#teacherReports" class="nav-link" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="teacherReports" data-key="t-calender">
                                            Reports
                                        </a>
                                        <div class="collapse menu-dropdown" id="teacherReports">
                                            <ul class="nav nav-sm flex-column">
                                                <li class="nav-item">
                                                    <a href="apps-calendar.html" class="nav-link" data-key="t-main-calender"> Observation Report  </a>
                                                </li>
                                                <li class="nav-item">
                                                    <a href="apps-calendar-month-grid.html" class="nav-link" data-key="t-month-grid"> Observation Criteria Report  </a>
                                                </li>
                                            </ul>
                                        </div>
                                    </li>
