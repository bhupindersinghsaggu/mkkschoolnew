...
<section class="cooking-course-choose-area">
    <div class="container">
        <div class="sec-title-style8">
            <h2>Fee  <span>Structure: 2024-25</span></h2>
        </div>
        <div class="row">
            <div class="col-md-12">
                <div class="privacy-desc">
                    <div class="list">
                        <ul class="list-class">
                         <a href="/assets/images/fee-structure/fee-structure-2024-25.pdf">   <i class="fa-regular fa-paper-plane theme-color"></i> Download Fee Structure</a>
                           <br>
                        </ul>
                    </div>
                </div>
