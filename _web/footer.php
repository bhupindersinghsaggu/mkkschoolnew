                       ...
                       <div class="footer-top-style9__inner">
                           <div class="left">
                               <div class="inner-title">
                                   <h3><span>Admission Open !..</span> for Academic Year 2026-27.</h3>
           ...
           <div class="container">
               <div class="row text-right-rtl">
                   ...
                   <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
                       <div class="single-footer-widget-style9 marbtm50">
                           <div class="title">
                           ...
                           <div class="our-company-info">
                               ...
                               <!-- <div class="button-box">
                                        <a class="btn-one" href="#"><span class="txt">Read More</span></a>
                                    </div> -->
                           </div>
                       </div>
                   </div>
                   ...
                   <!--Start single footer widget-->
                   <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
                       <div class="single-footer-widget-style9 single-footer-widget--link-box-style9 marbtm50">
                           <div class="title">
                               <h3>Useful Links</h3>
                           </div>
                           <div class="footer-widget-links-style9">
                                   ...
                                   <ul>
                                       <li>
                                           <a href="https://www.curtina.in/_Web/FrmfindTC.aspx">
                                               <span class="icon-right-arrow-1"></span>SLC Download
                                           </a>
                                       </li>
                                       <li>
                                       ...
                                       <li>
                                           <a href="https://curtina.in/_mobile/login.aspx?AppId=MKK">
                                               <span class="icon-right-arrow-1"></span>ERP Login
                                           </a>
                                       </li>
                                       <li>
                                           <a href="booklist.php">
                               ...
                               <!-- <div class="right">
                                        <ul>
                                            <li>
                                                <a href="#">
                                                    <span class="icon-right-arrow-1"></span>Admission
                                                </a>
                                            </li>
                                            <li>
                                                <a href="#">
                                                    <span class="icon-right-arrow-1"></span>How to Apply
                                                </a>
                                            </li>
                                            <li>
                                                <a href="#">
                                                    <span class="icon-right-arrow-1"></span>Scholarship
                                                </a>
                                            </li>
                                            <li>
                                                <a href="#">
                                                    <span class="icon-right-arrow-1"></span>Faq’s
                                                </a>
                                            </li>
                                        </ul>
                                    </div> -->
                           ...
                           <div class="footer-widget-links-style9">
                               <div class="left">
                                   <ul>
                                       <li>
                                           <a href="#">
                                               <span class="icon-right-arrow-1"></span>Ram Lal Chowk, Model Town,
                                       ...
                                       <li>
                                           <a href="#">
                                               <span class="icon-right-arrow-1"></span> 0180-4013047, 4004556
                                           </a>
                                       </li>
                                       <li>
                                           <a href="#">
                                               <span class="icon-right-arrow-1"></span>info@mkkschool.com
                                           </a>
                                       </li>
                                   </ul>
                               </div>
                   ...
                   <div class="col-xl-3 col-lg-12 col-md-12 col-sm-12">
                       <div class="single-footer-widget-style9">
                           <div class="title">
                               <h3>Locate us </h3>
                           </div>
           ...
           <div class="container">
               <div class="bottom-inner">
                   <div class="copyright-style9">
                       <p>
                           Copyright <a href="index.php">Dr. M.K.K. Arya Model School </a> Site created by <a
                               href="curtinatech.com">IT Department</a>
                       </p>
                   </div>
               </div>
           </div>
