...
<html lang="en">
<head>
    <title>Login - Dr. M.K.K. Arya Model School</title>
            ...
            <div class="login-content">
                <div class="login-userset">
                    <div class="login-logo logo-normal">
                        <img src="../assets/img/logo-small.png" alt="School Logo" style="max-width: 100px;">
                    </div>
                    ...
                    <form method="POST" id="loginForm">
                        ...
                        <div class="mb-3 form-group">
                            ...
                            <div class="input-group">
                                <input type="text" name="username" class="form-control border-end-0" placeholder="Enter your username" required>
