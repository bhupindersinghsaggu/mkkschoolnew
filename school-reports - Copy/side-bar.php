         ...
         <div id="sidebar-menu" class="sidebar-menu">
             <ul>
                 <li class="submenu-open">
                     ...
                     <ul>
                         <li><a href="https://mkkschool.com/school-reports/notebook/add.php"><i data-feather="box"></i><span>NoteBook Corrections</span></a></li>
                     </ul>
                 </li>
                 <li class="submenu-open">
                     <h6 class="submenu-hdr">Add Teacher</h6>
                     <ul>
                         <li><a href="https://mkkschool.com/school-reports/teacher/add.php"><i class="ti ti-stack-3 fs-16 me-2"></i><span>Add Teacher</span></a></li>
                     </ul>
                 </li>
             </ul>
         </div>
 ...
 <!-- <div class="sidebar sidebar-horizontal" id="horizontal-menu">
     <div id="sidebar-menu-3" class="sidebar-menu">
         <div class="main-menu">
             <ul class="nav-menu">
                 <li class="submenu">
                     <a href="index.php"><i class="ti ti-layout-grid fs-16 me-2"></i><span> Main Menu</span>
                     ...
                     <ul>
                         <li class="submenu">
                             ...
                             <ul>
                                 ...
                                 <li><a href="admin-dashboard.php">Admin Dashboard 2</a></li>
                         ...
                         <li class="submenu">
                             ...
                             <ul>
                                 ...
                                 <li><a href="search-list.php">Search List</a></li>
                             </ul>
                         </li>
                         <li class="submenu">
                             ...
                             <ul>
                                 ...
                                 <li><a href="layout-detached.php">Detached</a></li>
                                 <li><a href="layout-two-column.php">Two Column</a></li>
                                 <li><a href="layout-hovered.php">Hovered</a></li>
                     ...
                     <ul>
                             ...
                             <ul>
                                 <li class="submenu">
                                     <a href="javascript:void(0);"><span>Sales</span><span
                                             class="menu-arrow"></span></a>
                                     <ul>
                                         <li><a href="online-orders.php">Online Orders</a></li>
                                         <li><a href="pos-orders.php">POS Orders</a></li>
                                     </ul>
                                 </li>
                                 <li><a href="invoice.php"><span>Invoices</span></a></li>
                                 ...
                                 <li class="submenu">
                                     <a href="javascript:void(0);"><span>POS</span><span
                                             class="menu-arrow"></span></a>
                                     <ul>
                                         <li><a href="pos.php">POS 1</a></li>
                                         <li><a href="pos-2.php">POS 2</a></li>
                                         <li><a href="pos-3.php">POS 3</a></li>
                                         <li><a href="pos-4.php">POS 4</a></li>
                                         <li><a href="pos-5.php">POS 5</a></li>
                                     </ul>
                                 </li>
                             </ul>
                         </li>
                         <li class="submenu">
                             ...
                             <ul>
                                 ...
                                 <li><a href="gift-cards.php"><span>Gift Cards</span></a></li>
                                 <li class="submenu">
                         ...
                         <li class="submenu">
                             ...
                             <ul>
                                 ...
                                 <li><a href="income-category.php">Income Category</a></li>
                             </ul>
                         </li>
                         <li><a href="account-list.php"><span>Bank Accounts</span></a></li>
                         <li><a href="money-transfer.php"><span>Money Transfer</span></a></li>
                         <li><a href="balance-sheet.php"><span>Balance Sheet</span></a></li>
                         <li><a href="trial-balance.php"><span>Trial Balance</span></a></li>
                         <li><a href="cash-flow.php"><span>Cash Flow</span></a></li>
                         <li><a href="account-statement.php"><span>Account Statement</span></a></li>
                     </ul>
                 </li>
                 <li class="submenu">
                     ...
                     <ul>
                         <li class="submenu">
                             ...
                             <ul>
                                 ...
                                 <li><a href="ui-sortable.php">Sortable</a></li>
                                 <li><a href="ui-swiperjs.php">Swiperjs</a></li>
                             </ul>
                         </li>
                         <li class="submenu">
                         ...
                         <li class="submenu">
                             ...
                             <ul>
                                 ...
                                 <li><a href="icon-tabler.php">Tabler Icons</a></li>
                                 <li><a href="icon-bootstrap.php">Bootstrap Icons</a></li>
                                 <li><a href="icon-remix.php">Remix Icons</a></li>
                             </ul>
                         </li>
                         <li class="submenu">
                             ...
                             <ul>
                                 ...
                                 <li><a href="form-pickers.php">Form Picker</a></li>
                             </ul>
                         </li>
                         <li class="submenu">
                 ...
                 <li class="submenu">
                     ...
                     <ul>
                             ...
                             <ul>
                                 ...
                                 <li class="submenu">
                                     ...
                                     <ul>
                                         ...
                                         <li><a href="blog-tag.php">Blog Tags</a></li>
                         ...
                         <li class="submenu">
                             <a href="employee-salary.php"><span>Payroll</span><span
                                     class="menu-arrow"></span></a>
                             <ul>
                 ...
                 <li class="submenu">
                     ...
                     <ul>
                             ...
                             <ul>
                                 <li class="submenu submenu-two"><a href="javascript:void(0);">Invoice<span
                                     ...
                                     <ul>
                                         ...
                                         <li><a href="invoice-template.php">Invoice Template</a></li>
                                     </ul>
                                 </li>
                             ...
                             <ul>
                                 ...
                                 <li class="submenu submenu-two"><a href="javascript:void(0);">SMS<span
                                     ...
                                     <ul>
                                         ...
                                         <li><a href="sms-template.php">SMS Template</a></li>
                                     </ul>
                                 </li>
                         ...
                         <li>
                             <a href="signin.php"><span>Logout</span> </a>
                         </li>
                     </ul>
                 </li>
                 <li class="submenu">
                 ...
                 <div class="tab-content" id="v-pills-tabContent">
                     ...
                     <div class="tab-pane fade" id="hrm">
                         <ul>
                             ...
                             <li><a href="holidays.php"><span>Holidays</span></a>
                             </li>
                             <li class="submenu">
                                 <a href="employee-salary.php"><span>Payroll</span><span
                                         class="menu-arrow"></span></a>
                     ...
                     <div class="tab-pane fade" id="pages">
                         <ul>
                             ...
                             <li>
                                 <a href="pricing.php"><span>Pricing</span> </a>
                             </li>
                             <li>
