...
<div id="myModal" class="modal fade show" aria-modal="true" style="padding-right: 17px; display: block;">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <p class="school-name">Next Generation School" </p>
            <div class="online">"HOSTEL FACILITY FOR GIRLS AND BOYS"<br>
                <em>(6th Class Onwards)<br></em>
                <a href="https://curtina.in/_EazySchool/FormsWeb/frmHostel.aspx?AppId=crescent"><b><u>APPLY FOR HOSTEL</u></a></b>
            </div>
           ...
           <!-- <div class="admission-banner"> 30% Off in Admission Fee on First 100 Admissions </div>-->
            <!--<div class="admission-banner"> Conceptual clarity based classes till 20th April 2024 to bridge the learning gaps </div>-->
            <div class="online"><br>
                <a href="salient-features.php"><u>Salient Features</u></a><br><a href="https://play.google.com/store/apps/details?id=com.jet66.erp2"><u>Download School App</u></a> | <a href="https://curtina.in/CRESCENT/forms/frmstdpayonline.aspx"><u>Pay Online</u></a>
                <div class="pros"><a href="prospectus.pdf">
                        <marquee direction="left" height="30" width="350"><u>Download Prospectus 2024-25</u></marquee>
                    </a></div>
            </div>
        </div>
    </div>
...
<section id="slider-part" class="slider-active ">
    ...
    <div class="single-slider bg_cover pt-150" style=" width: 1349px;
        ...
        height:750px; background-image: url(images/slider/s-222.jpg)">
        <div class="container">
            <div class="row">
    ...
    <div class="single-slider bg_cover pt-150" style=" width: 1349px;
        ...
        opacity: 0;
        transition: opacity 500ms ease 0s;
        height:550px; background-image: url(images/slider/s-899.jpg)">
        <div class="container">
            <div class="row">
                <div class="col-xl-7 col-lg-9">
                    <!--  <div class="slider-cont">
    ...
    <div class="single-slider bg_cover pt-150" style=" width: 1349px;
        ...
        opacity: 0;
        transition: opacity 500ms ease 0s;
        height:550px; background-image: url(images/slider/s-105.jpg)">
        <div class="container">
            <div class="row">
                <div class="col-xl-7 col-lg-9">
                    <!--  <div class="slider-cont">
    ...
    <div class="single-slider bg_cover pt-150" style=" width: 1349px;
        ...
        opacity: 0;
        transition: opacity 500ms ease 0s;
        height:550px; background-image: url(images/slider/s-104.jpg)">
        <div class="container">
            <div class="row">
                <div class="col-xl-7 col-lg-9">
                    <!--  <div class="slider-cont">
            ...
            <div class="thought">
                ...
                <div class="span10">
                    <marquee scrollamount="5" scrolldelay="40" onmouseover="this.stop();" onmouseout="this.start();" style="color:#07294d;">
                        <ul>
                            <li>Welcome to Crescent Public School Admission Open For Session 2024-25 || Welcome to Crescent Public School Admission Open For Session 2024-25 || Welcome to Crescent Public School Admission Open For Session 2024-25 || </li>
                        </ul>
                    </marquee>
                </div>
            </div>
                                    ...
                                    <div class="entry-body">
                                        ...
                                        <div class="contact-info-menu">
                                            <div class="contact-info-item">
                                                ...
                                                <span style="color: #106EEB;">
                                                    <P>"World Day For  Cultural Diversity For Dialogue And  Development" celebration on 21st May 2024 at Crescent Public School, Banuri was a pulsating success to promote  cultural understanding, acceptance, and celebration among the students. The event encouraged students to embrace diversity, appreciate different cultures, and celebrate the unique contributions they make to our society.The videos and PPTs  presentation on the occasion added charm to the event.Tiny tots of Kindergarten Banuri had showcased their speaking skills by actively participating in "Warm Welcome With A Smile" activity.Students of  class 1st and 2nd were  enlightened with the knowledge about the food the children from different countries eat through the activity subtitled "International Food Cuisine." Crescentians of  classes 3rd to 8th learnt about the cultural styles of people around the world by the actively participating in various activities subtitled as"Flaunt It" and "How Different Is India" respectively highlighting the different elements of culture. Students of classes 9th to 12th realised the influence of global products and brands which they use in their daily lives through the activity "The World, One Big  Happy Family."
                                    ...
                                    <div class="entry-body">
                                        ...
                                        <div class="contact-info-menu">
                                            <div class="contact-info-item">
                                                <i class="fa fa-hand-o-right" aria-hidden="true"></i>
                                                <span style="color: #106EEB;">
                                                    <P>Crescent Public School Excels in Class X and XII (Science & Com) CBSE Board Examination 2023-24
Crescent Public School has once again demonstrated its academic prowess with exceptional results in class X &XII  CBSE Board Exams for the academic session 2023-24. The remarkable achievements of Crescentians  are a testament to the school's commitment to excellence. 
Highlights of Class 12th Result
<p>Pass Percentage    -100%</p>
<p>students above 90% -07</p>
<p>Students above 85%- 11</p>
<p>Students above 80%-  24</p>
<p>Highlights of Class 10th Result</p>
<p>Pass Percentage    -100%</p>
<p>students above 90% -08</p>
<p>Students above 85%- 16</p>
<p>Students above 80%-  22</p>
<p>We extent our heartfelt wishes for our students' continued success and fulfilment in all their future endeavours.</p>
                                    ...
                                    <div class="entry-body">
                                        ...
                                        <div class="contact-info-menu">
                                            <div class="contact-info-item">
                                                <i class="fa fa-hand-o-right" aria-hidden="true"></i>
                                                <span style="color: #106EEB;">
                                                    <P>The  fire fighting mock drill held at  Crescent Public School, Banuri campus on 8th May 2024 aimed to enhance safety awareness and preparedness among students and teachers in  the event of a fire emergency.Through a combination of theoretical knowledge dissemination and practical demonstration by firefighting personnel, the drill sought to equip participants with the necessary skills and knowledge to respond effectively to such situations.The mock drill commenced with an informative session on fire safety protocols, including the identification of fire hazards, evacuation procedures, and proper usage of firefighting equipment such as fire extinguishers.Following the theoretical briefing by fireman Mr.Bhag Singh, a practical demonstration was conducted by fire fighting officer Mr. Surender Kumar to aware Crescentians about the different types of fires and kinds of fire extinguishers used commonly.
  This demonstration included the proper operation of fire extinguishers, techniques for extinguishing different types of fires, and the importance of maintaining composure during emergencies.The enlightened faces of students reflected the success of this event.
                                    ...
                                    <div class="entry-body">
                                        ...
                                        <div class="contact-info-menu">
                                            <div class="contact-info-item">
                                                <i class="fa fa-hand-o-right" aria-hidden="true"></i>
                                                <span style="color: #106EEB;">
                                                    <P>Parent Orientation Programme(2024-2025)
 ''A parent is a teacher at home and a teacher is a parent in School and the child is the centre of our universe.'' 
An Orientation Programme  was organised for the parents of Kindergarten at Crescent Public school,Banuri and Panchrukhi(Kindergarten).The aim was to familiarise the parents as ''partners in progress'' with the curriculum rules and regulations of the school as well as  teaching methodologies and the co-scholastic  activities along with guidelines about effective parenting and different measures to nurture a child with love and care to build a strong foundation for a glorious future.All in all,it was a successful event.
                                    ...
                                    <div class="entry-body">
                                        ...
                                        <div class="contact-info-menu">
                                            <div class="contact-info-item">
                                                <i class="fa fa-hand-o-right" aria-hidden="true"></i>
                                                <span style="color: #106EEB;">
                                                    <P>"A Stage of Expression: Where Words Transform into Power"
The Saturday house-wise activities held on 27th April,2024 encompassed two significant events: Poem Recitation for junior classes and Declamation for senior classes. The purpose was to encourage participation, develop public speaking skills, and foster a spirit of healthy competition among students. Hindi Poem Recitation activity  witnessed enthusiastic participation from junior students across all houses. Each house presented the  poems with remarkable confidence and flair. The performances were engaging, showcasing the creativity and memorization skills of the participants.In the Declamation competition, senior students  delivered thought-provoking speeches on Moral Values and Value of Education. With eloquence and conviction, participants  demonstrated commendable oratory skills and in-depth research. The event provided a platform for students to express their viewpoints and engage in meaningful discourse. After careful deliberation, the  results of above said activities were announced.
                                    ...
                                    <div class="entry-body">
                                        ...
                                        <div class="contact-info-menu">
                                            <div class="contact-info-item">
                                                <i class="fa fa-hand-o-right" aria-hidden="true"></i>
                                                <span style="color: #106EEB;">
                                                    <P>"Winning doesn't always mean being first; winning means you are doing better than before."
The final  result  of classes 1st to 5th was declared on 22/03/24.It was really
an exhilarating moment for our shining stars  to receive result cards in front of their parents and a great moment for us also to witness smiles on parents' faces. The jubilant expressions of the educators, children and parents enveloped the School campus with warmth, exuberance and contentment. The position holders were awarded with mementos. Principal, Sh Manoj Bhardwaj extended his heartfelt congratulations to students, parents and teachers.
                                    ...
                                    <div class="entry-body">
                                        ...
                                        <div class="contact-info-menu">
                                            <div class="contact-info-item">
                                                <i class="fa fa-hand-o-right" aria-hidden="true"></i>
                                                <span style="color: #106EEB;">
                                                    <P>Crescent Public School, Banuri organised the much awaited farewell party on 10 February, 2024 for the outgoing batch of class Xll. The day was fieasta devoted to the years spent together with friends and teachers to reminisce joyous moments. The theme of valedictory party was "Aloha". The scintillating dance performances and the pulsating music rocked the ambience. Snappy and unique titles along with souvenirs given to the students of class Xll added spark to the event. The much awaited announcements of various titles accentuated the charm of entire event. Archit Goel and Aakriti Rana crowned as Mr. and Miss Crescent, while Sachin Rana and Shagun Thakur were adjudged Mr. and Miss Personality. The title winners of Mr. and Miss Naughty were Ruchit and Ishani Sharma respectively.
                                                        .
                                    ...
                                    <div class="entry-body">
                                        ...
                                        <div class="contact-info-menu">
                                            <div class="contact-info-item">
                                                <i class="fa fa-hand-o-right" aria-hidden="true"></i>
                                                <span style="color: #106EEB;">
                                                    <P>DUSSEHRA CELEBRATION️S
                                                        Dussehra is one of the most significant festivals of India that is celebrated all over the country with great enthusiasm.
                                                        The kindergarten students of Crescent Public School, Banuri celebrated Dussehra with enthusiasm.They came dressed in ethnical clothes and gave overwhelming response by actively participating in various activities like playing the roles of Lord Rama,Lakshmana and Mata Sita etc. The celebration concluded with the burning of the effigy of Ravana which represented the triumph of humanity over evil.The occasion served as an opportunity for everyone about the rich Indian culture and tradition.
                                                        .
                                    ...
                                    <div class="entry-body">
                                        ...
                                        <div class="contact-info-menu">
                                            <div class="contact-info-item">
                                                <i class="fa fa-hand-o-right" aria-hidden="true"></i>
                                                <span style="color: #106EEB;">
                                                    <P>"Learning Beyond The Classrooms"
                                                        In an exciting journey of learning and discovery, Crescentians witnessed an unforgettable educational visit to the vibrant cities of Bangalore, the royal heritage of Mysore, and the serene hills of Ooty. This captivating trip allowed students to delve into the rich cultural tapestry of Karnataka and Tamil Nadu, fostering a deeper understanding of history, nature, and regional traditions. From the bustling streets of Bangalore to the majestic palaces of Mysore and the tranquil beauty of Ooty's landscapes, our students found knowledge and inspiration around every corner.
                                                    <p></p>
                                                </span>
                                                <hr>
                                            </div>
                                    ...
                                    <div class="entry-body">
                                        ...
                                        <div class="contact-info-menu">
                                            <div class="contact-info-item">
                                                <i class="fa fa-hand-o-right" aria-hidden="true"></i>
                                                <span style="color: #106EEB;">
                                                    <P>HINDI DIWAS CELEBRATION 2023
                                                        Hindi Diwas was celebrated by the kindergarten students of Crescent Public school ,Banuri on 14th September with great reverence towards the language.
                                                        Students were explained the importance of celebrating Hindi Diwas in detail by the teacher. The kids celebrated this day by participating in Hindi Poem Recitation activity. The students recited various astounding Hindi rhymes using props. The confidence and creation of each child was commendable and were acknowledged for their efforts, which definitely put a bright smile on their faces making them happy and feel good about themselves.
                                    ...
                                    <div class="entry-body">
                                        ...
                                        <div class="contact-info-menu">
                                            <div class="contact-info-item">
                                                <i class="fa fa-hand-o-right" aria-hidden="true"></i>
                                                <span style="color: #106EEB;">
                                                    <P>GRANDPARENTS' DAY CELEBRATION AT KINDERGARTEN CRESCENT PUBLIC SCHOOL,BANURI.

                                                        The Pre-primary kids of Play, Nursery, LKG & UKG celebrated Grandparents' Day with abundance of respect and admiration for their grandparents'. The celebration began with tilak ceremony followed by dance, poem recitation, singing and a series of fun games. The children were very excited to see their grand dad or grand mom participate in the games and cheered them wholeheartedly. The grandparents' were very supportive and brought out the child in them through their active participation. The fond affection for their grandchildren reflected in the very fact that they held the hands of their respective grandchild while performing some of the games. The children seemed like a motivation factor for everyone to give their best. The teachers were very happy to see the happiness ushering in the faces of all the grandparents' who made the most of this wonderful day with happiness.
                                    ...
                                    <div class="entry-body">
                                        ...
                                        <div class="contact-info-menu">
                                            <div class="contact-info-item">
                                                <i class="fa fa-hand-o-right" aria-hidden="true"></i>
                                                <span style="color: #106EEB;">
                                                    <P>"It was a bright sunny day on 17th June 2023 when the students right from classes 4th to 12th were seen excited to go for their much awaited Picnic which provided a welcome break from the regular academic routine and allowed them to bond and create lasting memories with their teachers and friends.The Picnic spot was abullient with excitement and the feeling right from the commencement of the Picnic till the very end was splendid. Both the students & teachers were thrilled & enthusiastic.Various activities served as icing on the cake.The Crescentians enjoyed their day to the fullest & created beautiful memories to be cherished by them for a long time to come.
                                                        .
                                    ...
                                    <div class="entry-body">
                                        ...
                                        <div class="contact-info-menu">
                                            <div class="contact-info-item">
                                                <i class="fa fa-hand-o-right" aria-hidden="true"></i>
                                                <span style="color: #106EEB;">
                                                    <P>"On 20th May 2023, Crescentians of classes 6th to 8th embarked on an educational visit to Palampur Science Centre. The purpose of the visit was to enhance the students' understanding of scientific concepts through interactive exhibits and hands-on activities.
                                                        The visit to the Science Centre proved to be an enriching and educational experience for the students.
                                                        The visit not only fostered a love for science but also provided practical exposure to various scientific disciplines. Such experiences are crucial for the holistic development of students and inspire them to pursue scientific knowledge and careers in the future.



                                                        "World Day For Cultural Diversity For Dialogue And Development" celebration on 20th May 2023 at Crescent Public School, Banuri was a resounding success, promoting cultural understanding, acceptance, and celebration among the students and staff. The event encouraged students to embrace diversity, appreciate different cultures, and celebrate the unique contributions they make to our society.The videos and PPTs presentation on the occasion added charm to the event.Tiny tots of Kindergarten Banuri had showcased their speaking skills by actively participating in "Warm Welcome With A Smile" activity.Students of class 1st and 2nd were enlightened with the knowledge about the food the children from different countries eat through the activity subtitled "International Food Cuisine." Crescentians of classes 3rd to 8th learnt about the cultural styles of people around the world by the actively participating in various activities subtitled as"Flaunt It" and "How Different Is India" respectively highlighting the different elements of culture. Students of classes 9th to 12th realised the influence of global products and brands which they use in their daily lives through the activity "The World, One Big Happy Family."
                                                        .
                                    ...
                                    <div class="entry-body">
                                        ...
                                        <div class="contact-info-menu">
                                            <div class="contact-info-item">
                                                <i class="fa fa-hand-o-right" aria-hidden="true"></i>
                                                <span style="color: #106EEB;">
                                                    <P>"Youth fades; love droops; the leaves of friendship fall; A mother's secret hope outlives them all. "Keeping this bonding emotion in mind, Crescent Public School celebrated 'Mother's Day' on 12th May 2023 with full zeal & zest in its school premises . Heart-warming feelings of each & every student of classes 1st to 12th filled the air with intimacy, gratitude,appreciation & acknowledgement by making beautiful cards to honour their mothers.It was a pleasure watching the dynamic & energetic Crescentians preparing something unique and special for a special person. The outcome of their efforts was marvellous. All & all, it was an enjoyable & memorable day which left an indubitable mark on every heart.
                                                        .
                                    ...
                                    <div class="entry-body">
                                        ...
                                        <div class="contact-info-menu">
                                            <div class="contact-info-item">
                                                <i class="fa fa-hand-o-right" aria-hidden="true"></i>
                                                <span style="color: #106EEB;">
                                                    <P>The National Technology Day Celebration on 11th May 2023 at Crescent Public School, Banuri was a resounding success, providing a platform for students to showcase their technical skills, foster innovation and creativity. The event provided a platform for students to demonstrate their skills, exchange knowledge, and inspire others with their creations.
                                                        The enthusiastic Crescentians participated in plethora of activities which resonated with the theme "School to Startups- Igniting Young Minds to Innovate". Students created vibrant posters,flashcards and they also made interactive Power points and Presentations etc. to commemorate this special day.
                                    ...
                                    <div class="entry-body">
                                        ...
                                        <div class="contact-info-menu">
                                            <div class="contact-info-item">
                                                <i class="fa fa-hand-o-right" aria-hidden="true"></i>
                                                <span style="color: #106EEB;">
                                                    <P>The Investiture Ceremony for the academic session 2023-24 was held on 6th May 2023 with great gusto and dignity.The School Principal Manoj Bhardwaj conferred the student council with shashes followed by the oath taking ceremony where the newly appointed Student Council pledged to hold the School motto in high esteem and take on responsibility of fulfilling their duties to the best of their abilities.

                                                        The Ceremony was commenced with the lamp lighting Ceremony followed by prayer.The event was interspersed by mesmerizing dance recital and a song performance.The Ceremony was concluded with National Anthem.

                                                        Students Council At A Glance:
                                                        Head Boy: Rijul Rana
                                                        Head Girl: Akshita
                                                        Discipline in charge: Harshita
                                                        Sports Head: Rahul Singh
                                                        .
                                    ...
                                    <div class="entry-body">
                                        ...
                                        <div class="contact-info-menu">
                                            <div class="contact-info-item">
                                                ...
                                                <span style="color: #106EEB;">
                                                    <P>
                                                        Crescent Public School, Banuri organised Hawan Ceremony on 6th April 2023 to mark the commencement of the new academic session 2023-24. Students and parents in overwhelming number marked their presence on this red letter day.The whole ceremony was performed with divine fervour which created an ambience of spirituality.On this day, kindergarten of Crescent Public School, Banuri once again resounded with the tiny tots' laughter as they entered with happy faces and energetic steps.
                                                        School Principal Sh. Manoj Bhardwaj wished good health & showered the blessings on the students and guided them to work with dedication, determination and grab the bright future that awaits them.
                                                        .
                                    ...
                                    <div class="entry-body">
                                        ...
                                        <div class="contact-info-menu">
                                            <div class="contact-info-item">
                                                ...
                                                <span style="color: #106EEB;">
                                                    <P>
                                                        Crescentians viewing the live streaming of 'Pariksha Pe Charcha-2023' held on 27/01/2023 which is a part of the larger movement 'Exam Warriors'-led by Prime Minister, Narendra Modi to create a stress free atmosphere for youngsters and bring together students, parents and teachers. Painting and skit etc. activities were also conducted at Crescent Public School campus to commemorate this day.
                                                        .
                                    ...
                                    <div class="entry-body">
                                        ...
                                        <div class="contact-info-menu">
                                            <div class="contact-info-item">
                                                <i class="fa fa-hand-o-right" aria-hidden="true"></i>
                                                <span style="color: #106EEB;">
                                                    <P><B>KUDOS TO THE WINNERS </b>
                                                        Crescentians again proved their mettle by bagging positions in "30th Children Science Congress".

                                                        In 'Junior Urban Science Quiz' Gourvi Goswami and Dakshyani' proved their acumen by bagging 1st position and got selected for District level. In 'Senior Secondary Science Quiz,Vartika and Lakshita made their mark by securing 3rd position. In 'Junior Maths Olympiad' Anvita Sharma secured 2nd position and in 'Senior Maths Olympiad', Harsh Sharma bagged 3rd position and selected for District level.In 'Junior Science Activity Corner', Ashima Sharma and in 'Senior Science Activity Corner,' Priyanshi got 2nd position respectively and selected for District level also.
                                                        Principal, Sh.Manoj Bhardwaj congratulated the winners and wished them a bright future.
                                                        .
                                    ...
                                    <div class="entry-body">
                                        ...
                                        <div class="contact-info-menu">
                                            <div class="contact-info-item">
                                                <i class="fa fa-hand-o-right" aria-hidden="true"></i>
                                                <span style="color: #106EEB;">
                                                    <P><B>The Kindergarten campus of Crescent Public School Banuri was a sea of colours on the occasion of Fancy Dress Competition held on 16/11/2022. All students dressed in casuals, romping around and the sound of music, laughter and excitement on each child's face was a sight to behold. We had Spiderman, Army man Butterflies, Fairies etc. There was a colourful burst of happy hearts swaying in their dresses.
                                                            .
                                    ...
                                    <div class="entry-body">
                                        ...
                                        <div class="contact-info-menu">
                                            <div class="contact-info-item">
                                                <i class="fa fa-hand-o-right" aria-hidden="true"></i>
                                                <span style="color: #106EEB;">
                                                    <P><B>CRESCENT PUBLIC SCHOOL ADDS ANOTHER FEATHER TO ITS CAP
                                                            Respected Principal, Sh. Manoj BHardwaj receiving National award for 'Best School with Excellent Academic Inrastructure' from honourable Speaker of Punjab Legislative Assembly, Sh. Kultar Singh Sandhwan.
                                    ...
                                    <div class="entry-body">
                                        ...
                                        <div class="contact-info-menu">
                                            <div class="contact-info-item">
                                                <i class="fa fa-hand-o-right" aria-hidden="true"></i>
                                                <span style="color: #106EEB;">
                                                    <P><B>Student Led Conference cum Exhibition at Crescent Public School
                                                            On 10/09/2022,CPS campus was bustled with excitement on the occasion of 'Student Led Conference cum Exhibition' where Crescentians of classes 1st to 8th showcased their learning skills and enthralled the parents with their seamless presentations.Models,charts and pictures having rich display of innovation, creativity and artistic endeavour stole the show.The parents took an in- depth look at their child's hard work.The excitement and enthusiasm of students was evident throughout the event.
                                    ...
                                    <div class="entry-body">
                                        ...
                                        <div class="contact-info-menu">
                                            <div class="contact-info-item">
                                                <i class="fa fa-hand-o-right" aria-hidden="true"></i>
                                                <span style="color: #106EEB;">
                                                    <P><B>It was a bright sunny day on 25 June 2022,when the students right from classes 5th to 12th were seen excited to go for their much awaited picnic. The picnic spot was abuzz with hustle & bustle & the feeling right from the commencement of the picnic till the very end was splendid. Both the students & teachers were thrilled & enthusiastic. They threw themselves into the arms of various activities. The Crescentians enjoyed their day to the fullest & created beautiful memories to be cherished by them for a long time to come.
                                    ...
                                    <div class="entry-body">
                                        ...
                                        <div class="contact-info-menu">
                                            <div class="contact-info-item">
                                                <i class="fa fa-hand-o-right" aria-hidden="true"></i>
                                                <span style="color: #106EEB;">
                                                    <P><B>Crescent Public School, Banuri witnessed an enthusiastic International Yoga Day celebration on 21st June 2022 in its School premises. Special morning assembly was arranged in which objectives of International Yoga Day were discussed among the students and different asanas(postures) were performed by all the students under the guidance of their yoga teacher to bring about holistic approach to health and well- being among students.The importance of asanas was also explained simultaneously.It was a visual treat to watch students sync their minds and bodies to the idyllic chanting of 'Om'.The entire ambience reverberated with soft and melodious chanting of shlokas while the children performed the asanas.
                                                            .
                                    ...
                                    <div class="entry-body">
                                        ...
                                        <div class="contact-info-menu">
                                            <div class="contact-info-item">
                                                <i class="fa fa-hand-o-right" aria-hidden="true"></i>
                                                <span style="color: #106EEB;">
                                                    <P><B>To imbibe a true spirit of learning and to enhance the communication and language skills, Crescent Public School Banuri organised Role play and Extempore competitions on 18 June 2022 as a part of Saturday activities. In "Role Play" students of classes 1st to 7th played the roles of their choice and displayed their acting skills with full vigour and got the opportunity to explore,investigate, experiment and develope better communication skills. In "Extempore", students voiced their creative ideas with precision in the time slot of 2 minutes and they were judged on the basis of content, spontaneity, pronunciation and delivery of speech. All the students showed great fervour and poise in their respective activities.
                                                            .
                                    ...
                                    <div class="entry-body">
                                        ...
                                        <div class="contact-info-menu">
                                            <div class="contact-info-item">
                                                <i class="fa fa-hand-o-right" aria-hidden="true"></i>
                                                <span style="color: #106EEB;">
                                                    <P><B>Crescent Public School,Banuri celebrated ‘World Environment Day’ on 4th June 2022 with great fervour & took a pledge to make the planet green & clean. To motivate the students for making an effort to conserve the environment, a plethora of activities like Tree Plantation, Collage Making and Slogan Writing conducted to make this occasion remarkable. Students of classes 1st to 4th participated in Tree Plantation drive by planting the saplings with the vow to make the environment clean and green.Crescentians of classes 5th to 10th displayed their artistic sense in Collage Making competition by sticking and creating collage masterpieces through the imagination stuck on raw pictures to make them alive by connecting themselves to the theme.The young innovators of classes 11th & 12th also showcased their writing and artistic skills through the catchy slogans by actively participating in Slogan Writing competition.
                                                            .
                                    ...
                                    <div class="entry-body">
                                        ...
                                        <div class="contact-info-menu">
                                            <div class="contact-info-item">
                                                <i class="fa fa-hand-o-right" aria-hidden="true"></i>
                                                <span style="color: #106EEB;">
                                                    <P><B>World No Tobacco Day Celebration
                                                            Crescent Public School, Banuri initiated several activities like Painting,Slogan Writing and Collage Making etc. to commemorate "World No Tobacco Day" which is observed every year on 31st May to sensitize people to stay away from Tobacco as it is deleterious to health.All the Crescentians participated zealously and with great passion in the activities organised to aware them about the detrimental effects of Tobacco on physical and mental health.An awareness rally was also organised to create awareness and motivation towards Tobacco cessation among masses.
                                                            Let us have some glimpses
                                                            .
                                    ...
                                    <div class="entry-body">
                                        ...
                                        <div class="contact-info-menu">
                                            <div class="contact-info-item">
                                                <i class="fa fa-hand-o-right" aria-hidden="true"></i>
                                                <span style="color: #106EEB;">
                                                    <P><B>"Youth fades; love droops; the leaves of friendship fall; A mother's secret hope outlives them all. "Keeping this bonding emotion in mind, Crescent Public School celebrated 'Mother's Day' on 7 May 2022 with full zeal & zest in its school premises . Heart-warming feelings of each & every student of classes 1st to 12th filled the air with intimacy, gratitude,appreciation & acknowledgement through various activities like card- making & poem recitation etc. to honour their mothers.It was a pleasure watching the dynamic & energetic Crescentians preparing something unique and special for a special person. The outcome of their efforts was marvellous. All & all, it was an enjoyable & memorable day which left an indubitable mark on every heart.
                                                            .
                                    ...
                                    <div class="entry-body">
                                        ...
                                        <div class="contact-info-menu">
                                            <div class="contact-info-item">
                                                <i class="fa fa-hand-o-right" aria-hidden="true"></i>
                                                <span style="color: #106EEB;">
                                                    <P><B>"We have not inherited this earth from our forefathers; we have borrowed it from our children"
                                                            As a part of environmental education to save mother earth and to sensitize the children about the conservation of natural resources, “Earth Day” was celebrated on 22/04 /22 by the students of Crescent Public School, Banuri through educational and action-oriented activities.
                                                            They enthusiastically participated in various activities that included Painting,Poster Making Collage Making and Slogan Writing etc. to pay homage to mother earth.
                                                            .
                                    ...
                                    <div class="entry-body">
                                        ...
                                        <div class="contact-info-menu">
                                            <div class="contact-info-item">
                                                <i class="fa fa-hand-o-right" aria-hidden="true"></i>
                                                <span style="color: #106EEB;">
                                                    <P><B>Crescent Public School, Banuri organised the much awaited farewell party on 15/04/22 for the outgoing batch of class Xll.The day was fiesta devoted to the years spent together with friends and teachers to reminisce joyous moments.The theme of valedictory party was <b>Exuberanza.</b> The scintillating dance performances and the pulsating music rocked the ambience.Snappy and unique titles along with souvenirs given to the students of class Xll added spark to the event.The much awaited announcements of various titles accentuated the charm of entire event. Varun Patiyal and Sonal Singh were crowned as Mr. and Miss Crescent, while Anitya Gurung and Samaira Rana were adjudged Mr. and Miss Personality.The title winners of Mr. and Miss Naughty were Ansh Katoch and Avni Sharma respectively.Exuberanza
                                                            .
                                    ...
                                    <div class="entry-body">
                                        ...
                                        <div class="contact-info-menu">
                                            <div class="contact-info-item">
                                                <i class="fa fa-hand-o-right" aria-hidden="true"></i>
                                                <span style="color: #106EEB;">
                                                    <P><B>6 Day Workshop on Photography at CPS</B></P>Crescent Public School,Banuri organised a workshop conducted by "Big Boxx Professional Academy" representatives for classes 5 to 9 from 21/03/22 to 26/03/22 in School premises. Mr. Aman Shergil and Udit Sadyal from academy took the sessions on photography techniques. The idea of the workshop was to further the interests of amateur and relatively experienced photographers in different genres of photography. The representatives talked about different conditions that photographers face, gave tips on videography ,short videos, script writing and editing etc. and answered the students’ queries. Cameras were also provided to students for hands-on learning to apply what they had learned through the discussions. Students explored themselves practically with their mobiles.There was palpable excitement among students as they gathered in large number to learn more about photography.
                                                    .
                                    ...
                                    <div class="entry-body">
                                        ...
                                        <div class="contact-info-menu">
                                            <div class="contact-info-item">
                                                <i class="fa fa-hand-o-right" aria-hidden="true"></i>
                                                <span style="color: #106EEB;">
                                                    <P><B>The Final Term Result of Kindergarten</B></P>"Winning doesn't always mean being first; winning means you are doing better than before"
                                                    The Final Term Result of Kindergarten Banuri was declared on 26/03/22.It was really
                                                    an exhilarating moment for our shining stars to receive result cards in front of their parents and a great moment for us also to witness smiles on parents' faces.The jubilant expressions of the educators, children and parents enveloped the School campus with warmth, exuberance and contentment. Principal,Sh Manoj Bhardwaj extended his heartfelt gratitude and appreciation to all for coming out victorious from the upheaval caused by Covid-19 pandemic.
                                                    .
                                ...
                                <article class="entry">
                                    <div class="entry-body">
                                        ...
                                        <div class="contact-info-menu">
                                            <div class="contact-info-item">
                                                <i class="fa fa-hand-o-right" aria-hidden="true"></i>
                                                <span style="color: #106EEB;">“SEPARATE & SECURED KIDS WING WITH COVERED AREA”
                            <li>Age Group for various levels:</li>
            ...
            <article class="entry">
                <div class="entry-body">
                    ...
                    <div class="contact-info-menu">
                        <div class="contact-info-item">
                            <i class="fa fa-hand-o-right" aria-hidden="true"></i>
                            <span style="color: #106EEB;">“Experts Educational Skits/Dramas & Play Methods:

        <li>1. To equip children with the life skills.</li>
        <li>2. To encourage critical thinking and creativity.</li>
        <li>3. To spark co-operative learning.</li>
        <li>4. To select activities based on areas of children interest.</li>
        <li>5. To allow students for taking ownership of their learning.</li>
    ...
    <article class="entry">
        <div class="entry-body">
            ...
            <div class="contact-info-menu">
                <div class="contact-info-item">
                    <i class="fa fa-hand-o-right" aria-hidden="true"></i>
                    <span style="color: #106EEB;">Classes 1st to 12th :-
                        After the registration, the students will have to appear in the entrance test (1st to 10th , +1, & +2 comm) on spot time oral evaluation and +1 and +2 written test) which will be conducted in the school premises. The dates of the entrance test will be intimated to the applicant by the school. The admission to the classes 1st to +2 will be on the basis of entrance test and merits only.
                    </span>
                    <hr>
                </div>
            </div>
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-lg-4 col-md-8">
                ...
                <div class="admission-info mt-30">
                    ...
                    <p>Online Admission Open for 2024-25</p>
                        ...
                        <li>
                            <div class="single-feature">
                                <div class="icon">
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:svgjs="http://svgjs.com/svgjs" version="1.1" width="71" height="60" x="0" y="0" viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;background-color: #ff00008c;" xml:space="preserve" class="">
                                        <g>
                                            <g xmlns="http://www.w3.org/2000/svg">
                                                <g>
