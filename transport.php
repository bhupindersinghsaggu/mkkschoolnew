...
<section class="cooking-course-choose-area">
    <div class="container">
        <div class="sec-title-style8">
            <h2>Transport <span> Rules</span></h2>
        </div>
        <div class="row">
            <div class="col-xl-12">
 ...
 Transport facility is withdrawn in case any student is found damaging/indulging in indiscipline in the bus.
                                ...
                                <li>
                                    ...
                                    <ul class="mt-10">
                                        ...
                                        <li class="list-item-sub">(b) Shrieking and shouting in the bus. </li>
                                        <li class="list-item-sub">(c) Damaging bus property.</li>
                                        <li class="list-item-sub">(d) Discourtesy to other children and passersby.</li>
                                    </ul>
                                </li>
